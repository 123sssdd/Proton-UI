...
/**
 * ThemedChatDemo - 主题化对话容器展示
 *
 * 展示5个精美的像素风格主题：
 * 1. Retro Futurism - 霓虹光晕 + CRT 效果
 * 2. Neo Tokyo Night - 玻璃拟态 + 樱粉渐变
 * 3. Cyber Shrine - 金色神圣 + 神社红
 * 4. Dreamy Lo-fi - 抹茶绿 + 淡樱粉
 * 5. Vaporwave - 三色渐变 + 网格纹理
 */
export function ThemedChatDemo() {
